class RtcClient {
    ...
    async join() {
        ...
        try {
            this.client_.setProxyServer("wss://qcloud.rtc.qq.com:8687");
            var config= {
                url: "172.25.22.156:3478",
                username: "1598931133:Officer_109651_36298_128414125",
                credential: "in5QCFSVSvRZ6m0ZPNouAuw+lMY=",
                credentialType: "password",
            }
            this.client_.setTurnServer(config);
            console.warn(config);
            // join the room
